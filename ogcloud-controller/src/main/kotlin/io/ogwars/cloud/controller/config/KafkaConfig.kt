...
class KafkaConfig {
    ...
    @Bean
    fun liveChannelRetryTopic(): NewTopic = buildRetryTopic(KafkaTopics.LIVE_CHANNEL, BUSY_TOPIC_PARTITIONS)

    @Bean
    fun liveChannelDltTopic(): NewTopic = buildDltTopic(KafkaTopics.LIVE_CHANNEL, BUSY_TOPIC_PARTITIONS)
