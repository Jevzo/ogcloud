...
class GlobalExceptionHandler {
    ...
    fun handleNotFound(ex: RuntimeException): ErrorResponse = error(HttpStatus.NOT_FOUND, ex.message ?: "Not found")
    ...
    fun handleConflict(ex: RuntimeException): ErrorResponse = error(HttpStatus.CONFLICT, ex.message ?: "Conflict")
    ...
    fun handleBadRequest(ex: RuntimeException): ErrorResponse =
        error(HttpStatus.BAD_REQUEST, ex.message ?: "Bad request")

    @ExceptionHandler(InvalidCredentialsException::class, InvalidRefreshTokenException::class)
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    fun handleUnauthorized(ex: RuntimeException): ErrorResponse =
        error(HttpStatus.UNAUTHORIZED, ex.message ?: "Unauthorized")
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    fun handleHandlerMethodValidation(ex: HandlerMethodValidationException): ErrorResponse {
