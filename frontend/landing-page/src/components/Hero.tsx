...
const Hero = () => {
    return (
        <section className="px-5 pb-24 pt-36 sm:px-6 md:pb-32 md:pt-48 lg:px-8">
            <div
                className="mx-auto grid max-w-7xl gap-10 lg:gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,35rem)] lg:items-center">
            ...
            <span className="relative flex h-2.5 w-2.5">
              ...
              cluster level.
                ...
                Setup preview
                        ...
                        <div
                            className="rounded-2xl border border-white/6 bg-slate-950/70 p-4 font-mono text-[11px] leading-6 text-slate-300">
