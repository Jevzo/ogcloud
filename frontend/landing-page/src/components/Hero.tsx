        ...
        <section className="px-5 pb-24 pt-36 sm:px-6 md:pb-32 md:pt-48 lg:px-8">
            <div className="mx-auto grid max-w-7xl gap-10 lg:gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,35rem)] lg:items-center">
                <div className="text-center lg:text-left">
                    ...
                    >
                        OgCloud is the Kubernetes-native control plane for Minecraft networks:
                        deploy, scale, drain, and heal servers with game-state awareness, built-in
                        permissions, and a dedicated TCP load balancer.
                    </motion.p>
