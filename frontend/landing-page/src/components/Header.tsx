...
const Header = () => {
    ...
    return (
        ...
        >
            <div
                className="mx-auto flex h-16 max-w-7xl items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-5 shadow-[0_18px_50px_rgba(0,0,0,0.28)] backdrop-blur-2xl sm:px-6 lg:px-8">
                <a
                    href="/"
