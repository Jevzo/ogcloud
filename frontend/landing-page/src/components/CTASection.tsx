    ...
    return (
        <section className="px-5 py-24 sm:px-6 md:py-32 lg:px-8">
            <div className="mx-auto max-w-6xl">
                <div className="relative overflow-hidden rounded-[2rem] border border-white/8 bg-white/[0.04] px-6 py-12 text-center shadow-[0_20px_70px_rgba(0,0,0,0.32)] backdrop-blur-xl sm:px-10 md:px-14">
                    <div
                        aria-hidden="true"
