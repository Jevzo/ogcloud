...
const FEATURE_ROWS: FeatureRow[] = [
    ...
    },
    {
        ...
        competitors:
            "Mostly monolithic Java nodes or a narrower Agones-centric deployment model.",
    },
    {
        feature: "Autoscaling",
        ...
        competitors:
            "Typically fixed min/max rules, player-count heuristics, or fleet buffers.",
    },
    {
        ...
        competitors:
            "Usually absent, proxy-only, or delegated to generic Kubernetes services.",
    },
    {
        feature: "Permissions",
        ...
        competitors:
            "Often extra modules, basic plugin support, or bring-your-own tooling.",
    },
    {
        ...
        competitors:
            "Usually proxy-only, limited, or missing as a first-class feature.",
    },
    {
        ...
        competitors:
            "Usually limited watchdog behavior or no built-in failure recovery.",
    },
] as const;
...
const ComparisonSection = () => {
    return (
        <section
            id="comparison"
            className="px-5 py-24 sm:px-6 md:py-32 lg:px-8"
        >
          ...
          <span className="mb-4 block text-xs font-semibold uppercase tracking-[0.22em] text-primary">
            Why OgCloud?
                    ...
                    <p className="mt-5 text-base leading-8 text-text-muted md:text-lg">
                        This is a single aggregated view across CloudNet, SimpleCloud,
                        Shulker, and TimoCloud, focused on the seven capability gaps that
                        matter most.
                    </p>
                </motion.div>
            ...
            <span className="inline-flex items-center gap-2 font-medium">
              ...
              Competitor column summarizes the common pattern across the major alternatives above.
            </span>
                    </div>
