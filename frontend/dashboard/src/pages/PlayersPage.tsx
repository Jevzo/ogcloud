...
const getPlayerStatusTone = (online: boolean) =>
    online ? "bg-emerald-500/10 text-emerald-400" : "bg-slate-800 text-slate-300";
            ...
            >
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-400">
                        Review persisted player records, update permission groups, and move active
                        players between servers.
                    </p>
                </div>
            </motion.section>
