...
const applyFirstTemplateDefaults = (values: GroupFormValues, templates: TemplateRecord[]) => {
...
const GroupsPage = () => {
    ...
    const [createValues, setCreateValues] = useState<GroupFormValues>(createEmptyGroupValues());
                        ...
                        groups.map((group) => (
                            ...
                            >
                                <div className="relative h-32 overflow-hidden bg-slate-800">
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-linear-to-b from-slate-950/0 via-slate-950/12 via-35% to-slate-900" />
                                    <div className="absolute left-4 top-4 flex items-center gap-2">
                                        ...
                                        {group.maintenance && (
                                            <span className="rounded bg-amber-500/12 px-2 py-0.5 text-[10px] font-bold uppercase text-amber-300">
                                                Maintenance
                                            </span>
                                        )}
                                    </div>
