...
export const dashboardNavSections: readonly DashboardNavSection[] = [
    {
        ...
        items: [
            ...
            },
            {
                ...
                href: "/players",
                icon: UsersIcon,
                matchPatterns: ["/players", "/players/:playerUuid"],
            },
            {
                title: "Network",
                href: "/network",
                icon: NetworkIcon,
                matchPatterns: ["/network", "/network/:section"],
            },
        ],
    },
    {
...
export const dashboardRouteDefinitions: readonly DashboardRouteDefinition[] = [
    ...
    { pattern: "/players/:playerUuid", title: "Player Details" },
    { pattern: "/inbox", title: "Inbox" },
    { pattern: "/network", title: "Network" },
    { pattern: "/network/:section", title: "Network" },
