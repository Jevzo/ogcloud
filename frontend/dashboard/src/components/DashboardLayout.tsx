        ...
        <div className="min-h-screen bg-background-dark text-slate-100 lg:h-screen">
            <div className="flex min-h-screen flex-col overflow-hidden lg:h-screen lg:flex-row">
                ...
                <div className="flex min-w-0 flex-1 flex-col overflow-y-auto">
                    ...
                    <footer
                        className="mt-auto flex flex-col gap-2 border-t border-slate-800 px-4 py-5 text-xs text-slate-500 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
