    ...
    if (status === "refreshing") {
        return (
            <div className="flex min-h-screen items-center justify-center bg-background-dark px-6">
                <div
                    className="rounded-3xl border border-white/10 bg-white/5 px-6 py-5 text-sm text-text-muted shadow-[0_18px_60px_rgba(0,0,0,0.35)] backdrop-blur-2xl">
